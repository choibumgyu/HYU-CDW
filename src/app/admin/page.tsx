...
export default function AdminPage() {
    ...
    const fetchBlockedUsers = async () => {
        const response = await fetch(endpoint+"/api/auth/blocked_users", {
            headers: {
                Authorization: `Bearer ${token}`,
            },
        });
    ...
    const handleApprove = async (email: string) => {
        const response = await fetch(endpoint+"/api/auth/approve", {
            method: "POST",
            headers: {
    ...
    const handleReject = async (email: string) => {
        const response = await fetch(endpoint+"/api/auth/reject", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${token}`,
    ...
    const handleUnblock = async (email: string) => {
        const response = await fetch(endpoint+"/api/auth/unblock", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                Authorization: `Bearer ${token}`,
    ...
    const handleSearch = async () => {
       const response = await fetch(`${endpoint}/api/auth/search?name=${searchName}`, {
            headers: {
                Authorization: `Bearer ${token}`,
            },
        });
